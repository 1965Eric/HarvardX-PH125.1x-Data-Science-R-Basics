...
1. To find the solutions to an equation of the format $𝑎𝑥ˆ2+𝑏𝑥+𝑐$, use the quadratic equation: $𝑥=−𝑏±sqrt(𝑏ˆ2−4𝑎𝑐) / 2𝑎$.

What are the two solutions to $2𝑥ˆ2−𝑥−4=0 ? Use the quadratic equation. (Report the greater of the two solutions first, using 3 significant digits for both solutions)
