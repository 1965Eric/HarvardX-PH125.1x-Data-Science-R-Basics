...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{char_len <-}\StringTok{ }\KeywordTok{nchar}\NormalTok{(murders}\OperatorTok{$}\NormalTok{state)}
\KeywordTok{head}\NormalTok{(char_len)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Assign the state abbreviation when the state name is longer than 8 characters }
\NormalTok{char_len <-}\StringTok{ }\KeywordTok{nchar}\NormalTok{(murders}\OperatorTok{$}\NormalTok{state)}
\NormalTok{new_names <-}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(char_len }\OperatorTok{>}\StringTok{ }\DecValTok{8}\NormalTok{, murders}\OperatorTok{$}\NormalTok{abb, murders}\OperatorTok{$}\NormalTok{state)}
\end{Highlighting}
\end{Shaded}
